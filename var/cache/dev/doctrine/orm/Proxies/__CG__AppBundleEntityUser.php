...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'avatar', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'shops'];
        }
